...
namespace Library_ado4 {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, int PageCount, string Topic, int Code) {
        ...
        public partial class BooksRow : global::System.Data.DataRow {
            ...
            public string Topic {
                get {
                    try {
                        return ((string)(this[this.tableBooks.TopicColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableBooks.TopicColumn] = value;
                }
            }
            ...
            public int Code {
                get {
                    try {
                        return ((int)(this[this.tableBooks.CodeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsTopicNull() {
                return this.IsNull(this.tableBooks.TopicColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetTopicNull() {
                this[this.tableBooks.TopicColumn] = global::System.Convert.DBNull;
            }
...
namespace Library_ado4.LibraryDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([BookID] = @Original_BookID) AND ([Title] = @Original_Title) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_PageCount = 1 AND [PageCount] IS NULL) OR ([PageCount] = @Original_PageCount)) AND ((@IsNull_Topic = 1 AND [Topic] IS NULL) OR ([Topic] = @Original_Topic)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Title], [Author], [PageCount], [Topic], [Code]) VALUE" +
                "S (@Title, @Author, @PageCount, @Topic, @Code);\r\nSELECT BookID, Title, Author, P" +
                "ageCount, Topic, Code FROM Books WHERE (BookID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [PageCount] = @PageCount, [Topic] = @Topic, [Code] = @Code WHERE (([BookID] = @Original_BookID) AND ([Title] = @Original_Title) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_PageCount = 1 AND [PageCount] IS NULL) OR ([PageCount] = @Original_PageCount)) AND ((@IsNull_Topic = 1 AND [Topic] IS NULL) OR ([Topic] = @Original_Topic)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)));
SELECT BookID, Title, Author, PageCount, Topic, Code FROM Books WHERE (BookID = @BookID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Library_ado4.Properties.Settings.Default.LibraryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookID, Title, Author, PageCount, Topic, Code FROM dbo.Books";
        ...
        public virtual int Delete(int Original_BookID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_PageCount, string Original_Topic, global::System.Nullable<int> Original_Code) {
            ...
            if ((Original_Code.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((int)(Original_Code.Value));
            }
            else {
        ...
        public virtual int Insert(string Title, string Author, global::System.Nullable<int> PageCount, string Topic, global::System.Nullable<int> Code) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, global::System.Nullable<int> PageCount, string Topic, global::System.Nullable<int> Code, int Original_BookID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_PageCount, string Original_Topic, global::System.Nullable<int> Original_Code, int BookID) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            if ((PageCount.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(PageCount.Value));
            }
            else {
            ...
            if ((Original_Topic == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_Topic));
            }
            if ((Original_Code.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, global::System.Nullable<int> PageCount, string Topic, global::System.Nullable<int> Code, int Original_BookID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_PageCount, string Original_Topic, global::System.Nullable<int> Original_Code) {
            return this.Update(Title, Author, PageCount, Topic, Code, Original_BookID, Original_Title, Original_Author, Original_PageCount, Original_Topic, Original_Code, Original_BookID);
        }
    }
